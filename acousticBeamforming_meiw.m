...
useFMCW = true; % if false singletone sine wave
useTrace = true; % if false generated received signal is used
...
if useTrace
    ...
    if useFMCW
        ...
        sine_freq = 15; % 12; %[12, 15, 18, 19, 20];
        prefix = sprintf('/recording-sine/sin%d-90_%d_%d',sine_freq, trial, Fs);
    end
    ...
    rx = rx_raw + noise; % adding some noise
end
